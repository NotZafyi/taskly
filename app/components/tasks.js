  ...
  return (
    <div className="bg-rd flex w-screen h-screen p-4 gap-2 text-gray-400">
      <ToastContainer
        ...
        theme="dark"
      />
      <div className=" w-40 rounded-lg p-1 flex flex-col gap-1 justify-between items-center fixed max-h-screen h-[90vh]  ">
        <div>
          <Image
            src={"/5.gif"}
            width={70}
      ...
      <div className="flex flex-col">
        ...
        <div className="min-w-screen mt-16 ml-52 min-h-[80vh] flex flex-col gap-2">
          <div className="hide-scrollbar min-h-full overflow-y-scroll min-w-[720] flex flex-col gap-4 p-4 bg-[#070707ba] border border-gray-900 rounded-xl">
            ...
            if (collectiontasks.show == true) {
              return (
                <div
                  ...
                  className="hide-scrollbar min-h-[80vh] max-h-full overflow-y-scroll flex flex-col gap-4 min-w-full p-4 bg-[#070707ba] border border-gray-900 rounded-xl"
                >
                  <div className="flex justify-between items-center max-h-full">

    ...
    <div className="bg-rd flex w-screen h-screen p-4 gap-2 text-gray-400">
      ...
      <div className="flex flex-col">
        ...
        <div className="mt-16 ml-52 min-h-[80vh] grid grid-cols-3 gap-2">
          ...
          <div className="box hide-scrollbar min-h-[82vh] max-h-[82vh] overflow-y-scroll flex flex-col gap-4 p-4 bg-[#070707ba] border border-gray-900 rounded-xl">
            ...
            if (collectiontasks.show == true) {
              return (
                <div
                  ...
                  className="box hide-scrollbar min-h-[82vh] max-h-[82vh] overflow-y-scroll flex flex-col gap-4 p-4 bg-[#070707ba] border border-gray-900 rounded-xl"
                >
                  <div className="flex justify-between items-center max-h-full">
